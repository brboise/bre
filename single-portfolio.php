           ...
           <?php
                ...
                if ( has_post_thumbnail() ) : ?>
                    ...
                    <div id="post-media" class="clr">
                        <?php echo do_shortcode('[gallery link="none" orderby="menu_order" columns="0" size="large" itemtag="li" icontag="div"]'); ?>
                        <?php
...
<br />
    ...
    <div id="primary" style="max-width:735px !important"  class="content-area clr">

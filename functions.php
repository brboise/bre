...
function bluerockre_scripts() {
    ...
    wp_enqueue_style ( 'style', get_theme_root_uri() . '/bluerockre/style.css' );
    wp_enqueue_style ( 'bluerockre', get_theme_root_uri() . '/bluerockre/css/bluerockre.css' );
    wp_enqueue_style ( 'responsive', get_theme_root_uri() . '/bluerockre/css/responsive.css' );
